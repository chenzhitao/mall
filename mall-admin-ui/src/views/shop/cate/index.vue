  ...
  <div class="app-container">
    ...
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
        <!-- 搜索 -->
        <el-input v-model="query.cateName" clearable size="small" placeholder="输入分类名称搜索" style="width: 200px;"
    ...
    <el-dialog append-to-body :close-on-click-modal="false" :before-close="crud.cancelCU"
      ...
      <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
        ...
        <el-form-item label="分类图片">
          ...
          <i class="el-icon-info"></i>建议尺寸:一级分类(49*49)px;二级分类(281*83)px
        </el-form-item>
    ...
    <el-table ref="table" v-loading="crud.loading" :tree-props="{children: 'children', hasChildren: 'hasChildren'}"
      ...
      <el-table-column v-permission="['admin','cate:edit','cate:del']" label="操作" width="330px" align="center"
                       fixed="right">
        <template slot-scope="scope">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      copyrouter(row) {
        console.log(row, '-----------id')
        let url = '/pages/shop/GoodsList/index?id=' + row.id;
