...
export default {
  ...
  data() {
    return {
      ...
      checkList: [],printChecked: false, batchHandle: '', batchExport: '', listContent: [],
      queryTypeOptions: [
  ...
  methods: {
    ...
    beforeInit() {
      ...
      const sort = 'id,desc'
      this.params = { 
          page: this.page, size: this.size, sort: sort, orderStatus: this.status, orderType: 5, storeId: this.storeId,
