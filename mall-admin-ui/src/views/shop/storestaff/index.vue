    ...
    <div class="head-container">
      ...
      <el-dialog :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title" width="500px">
        <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
          ...
          <el-form-item label="所属店长" prop="spreadUid">
            <cuser v-model="form.spreadUser"></cuser>
          </el-form-item>
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column v-if="columns.visible('spreadNickname')" prop="spreadNickname" label="所属店长" />
...
const defaultForm = { user: {uid: null, nickname: null,avatar: null}, spreadUser: {uid: null,nickname: null, avatar: null}, id: null, uid: null, avatar: null, spreadUid: null, spreadAvatar: null, spreadNickname: null, storeId: null, staffName: null, phone: null, verifyStatus: 1, status: null, addTime: null, nickname: null, storeName: null }
export default {
