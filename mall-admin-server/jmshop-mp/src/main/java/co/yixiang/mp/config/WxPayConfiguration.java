...
public class WxPayConfiguration {
    ...
    public static WxPayService getPayService() {
        WxPayService wxPayService = payServices.get(ShopConstants.JMSHOP_WEIXIN_PAY_SERVICE);
        if (wxPayService == null || RedisUtil.get(ShopConstants.JMSHOP_WEIXIN_PAY_SERVICE) == null) {
            ...
            payServices.put(ShopConstants.JMSHOP_WEIXIN_PAY_SERVICE, wxPayService);

            //增加标识
            RedisUtil.set(ShopConstants.JMSHOP_WEIXIN_PAY_SERVICE, "jmshop");
        }
        return wxPayService;
    }
    ...
    public static WxPayService getWxAppPayService() {
        WxPayService wxPayService = payServices.get(ShopConstants.JMSHOP_WEIXIN_MINI_PAY_SERVICE);
        if (wxPayService == null || RedisUtil.get(ShopConstants.JMSHOP_WEIXIN_PAY_SERVICE) == null) {
            WxPayConfig payConfig = new WxPayConfig();
            ...
            wxPayService = new WxPayServiceImpl();
            wxPayService.setConfig(payConfig);
            payServices.put(ShopConstants.JMSHOP_WEIXIN_MINI_PAY_SERVICE, wxPayService);
    ...
    public static WxPayService getAppPayService() {
        WxPayService wxPayService = payServices.get(ShopConstants.JMSHOP_WEIXIN_APP_PAY_SERVICE);
        if (wxPayService == null || RedisUtil.get(ShopConstants.JMSHOP_WEIXIN_PAY_SERVICE) == null) {
            WxPayConfig payConfig = new WxPayConfig();
            ...
            wxPayService = new WxPayServiceImpl();
            wxPayService.setConfig(payConfig);
            payServices.put(ShopConstants.JMSHOP_WEIXIN_APP_PAY_SERVICE, wxPayService);
    ...
    public static void removeWxPayService() {
        RedisUtil.del(ShopConstants.JMSHOP_WEIXIN_PAY_SERVICE);
        payServices.remove(ShopConstants.JMSHOP_WEIXIN_PAY_SERVICE);
        payServices.remove(ShopConstants.JMSHOP_WEIXIN_MINI_PAY_SERVICE);
        payServices.remove(ShopConstants.JMSHOP_WEIXIN_APP_PAY_SERVICE);
    }
